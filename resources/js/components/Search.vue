<template>
    <transition name="bounce">
        <section class="absolute z-10" v-show="show">
            <div class="mx-auto container h-auto bg-red-lightest rounded-b shadow-md">
    ...
    export default {
        ...
        methods: {
            getArticles: _.debounce(function() {
                ...
                axios.get(`${this.appUrl}/search?hl=${this.locale}&q=${this.query}`)
                    .then((response) => {
                        if (response.data) {
