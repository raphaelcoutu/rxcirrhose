...
@endif
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="w-3/4 flex">
            <select name="childa_category" class="bg-white border border-red-400 mr-4">
            ...
            <input type="text" name="childa_text" class="border border-red-400 rounded w-full p-2"
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="w-3/4 flex">
            <select name="childb_category" class="bg-white border border-red-400 mr-4">
            ...
            <input type="text" name="childb_text" class="border border-red-400 rounded w-full p-2"
    ...
    <div class="flex justify-between mt-4">
        ...
        <div class="w-3/4 flex">
            <select name="childc_category" class="bg-white border border-red-400 mr-4">
            ...
            <input type="text" name="childc_text" class="border border-red-400 rounded w-full p-2"
    ...
    <div class="flex justify-between mt-4">
        ...
        <textarea name="absorption" class="w-3/4 border border-red-400 rounded p-2 h-48">{{ old('absorption', optional($drug ?? null)->absorption) }}</textarea>
    </div>

    <div class="flex justify-between mt-4">
        <label for="distribution" class="w-1/4">Distribution:</label>
        <textarea name="distribution" class="w-3/4 border border-red-400 rounded p-2 h-48">{{ old('distribution', optional($drug ?? null)->distribution) }}</textarea>
    </div>

    <div class="flex justify-between mt-4">
        <label for="metabolisme" class="w-1/4">Métabolisme:</label>
        <textarea name="metabolisme" class="w-3/4 border border-red-400 rounded p-2 h-48">{{ old('metabolisme', optional($drug ?? null)->metabolisme) }}</textarea>
    </div>

    <div class="flex justify-between mt-4">
        <label for="elimination" class="w-1/4">Élimination:</label>
        <textarea name="elimination" class="w-3/4 border border-red-400 rounded p-2 h-48">{{ old('elimination', optional($drug ?? null)->elimination) }}</textarea>
    </div>

    <div class="flex justify-between mt-4">
        <label for="official" class="w-1/4">Monographie:</label>
        <textarea name="official" class="w-3/4 border border-red-400 rounded p-2 h-48">{{ old('official', optional($drug ?? null)->official) }}</textarea>
    </div>

    <div class="flex justify-between mt-4">
        <label for="litterature" class="w-1/4">Littérature:</label>
        <textarea name="litterature" class="w-3/4 border border-red-400 rounded p-2 h-96">{{ old('litterature', optional($drug ?? null)->litterature) }}</textarea>
    </div>

    <div class="flex justify-end mt-4">
        @if(isset($drug))
            <a href="{{ route('admin.article-translations.edit', $drug->articleTranslation->id) }}" class="no-underline text-gray-600 p-2 border border-gray-500 rounded mr-4">Retour à la classe</a>
            <a href="{{ route('article-translations.show', $drug->articleTranslation->id) }}" class="no-underline text-gray-600 p-2 border border-gray-500 rounded mr-4">Visualiser la fiche</a>
        @else
            <a href="{{ route('admin.article-translations.edit', $articleTranslation->id) }}" class="no-underline text-gray-600 p-2 border border-gray-500 rounded mr-4">Retour à la classe</a>
            <a href="{{ route('article-translations.show', $articleTranslation->id) }}" class="no-underline text-gray-600 p-2 border border-gray-500 rounded mr-4">Visualiser la fiche</a>
        @endif
