...
@section('content')
    ...
    <div class="mx-auto container flex flex-grow justify-between items-start pt-4 leading-loose tracking-normal">
        <div class="mx-auto w-full sm:w-3/4 bg-white border-t-8 border-red px-6 py-3 shadow">
            ...
            <p class="mt-2 tracking-tight font-thin text-sm">Toute personne qui utilise ces informations le fait à ses propres risques et, ce faisant, accepte de dégager RxCirrhose/RxCirrhosis et ses fournisseurs de contenu de tout dommage, responsabilité, perte, blessure, frais et dépenses (notamment les frais et honoraires juridiques) découlant de l’utilisation par cette personne de l’information présentée sur ce site web et sur les sites web auxquels il est relié.</p>

            <p class="mt-2 tracking-tight font-thin text-sm">RxCirrhose/RxCirrhosis n’est pas responsable des dommages ou blessures provoqués notamment, sans en limiter la portée, par tout défaut, inexécution, erreur, omission, interruption, défaut, retard d’application ou de transmission, virus informatique ou défaillance de ligne. RxCirrhose/RxCirrhosis ou ses fournisseurs de contenu ne sont pas responsables des dommages ou blessures, notamment, sans en limiter la portée, des dommages spéciaux ou consécutifs pouvant résulter de l’utilisation ou de l’incapacité d’utilisation du matériel sur ce site web, même si RxCirrhose/RxCirrhosis ou un représentant autorisé de RxCirrhose/RxCirrhosis a été informé de la possibilité de ces dommages.</p>
