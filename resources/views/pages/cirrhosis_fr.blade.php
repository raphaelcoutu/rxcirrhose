...
@section('content')
    ...
    <div class="mx-auto container flex flex-grow justify-between items-start pt-4 leading-loose tracking-normal">
        <div class="mx-auto w-full bg-white border-t-8 border-red-500 px-6 py-3 shadow">
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400">Étiologies</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400">Épidémiologie</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400">Présentation clinique</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400">Pathophysiologie et complications</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400">Sévérité de la cirrhose</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400">Altérations pharmacocinétiques</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400">Démarche de prise en charge</h3>
