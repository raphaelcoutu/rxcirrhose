...
@section('content')
    ...
    <div class="mx-auto container flex flex-grow justify-between items-start pt-4 leading-loose tracking-normal">
        <div class="mx-auto w-full bg-white border-t-8 border-red-500 px-6 py-3 shadow dark:bg-slate-800">
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Étiologies</h3>
            ...
            <table class="w-full">
                ...
                <tr>
                    ...
                    <td class="border-b-2 border-gray-100 dark:border-slate-600 dark:text-gray-300">hépatite B, hépatite C, hépatite delta</td>
                </tr>
                <tr>
                    ...
                    <td class="border-b-2 border-gray-100 dark:border-slate-600 dark:text-gray-300">hémochromatose, maladie de Wilson, déficit en alpha1-antitrypsine</td>
                </tr>
                <tr>
                    ...
                    <td class="border-b-2 border-gray-100 dark:border-slate-600 dark:text-gray-300">maladies auto-immunes, cholangite biliaire primitive</td>
                </tr>
                <tr>
                    ...
                    <td class="border-b-2 border-gray-100 dark:border-slate-600 dark:text-gray-300">Budd-Chiari, insuffisance cardiaque droite</td>
                </tr>
                <tr>
                    ...
                    <td class="dark:text-gray-300">alcool, stéatose non alcoolique, cryptogénique</td>
                </tr>
                </tbody>
            </table>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Épidémiologie</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Présentation clinique</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Pathophysiologie et complications</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Sévérité de la cirrhose</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Altérations pharmacocinétiques</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Démarche de prise en charge</h3>
...
un patient se présente avec une ordonnance d’un produit pour lequel aucune fiche n’est encore disponible, nous proposons l’approche suivante :
            ...
            <div class="flex flex-col justify-center items-center">
                <div class="bg-gray-100 rounded border border-gray-400 text-gray-800 font-thin shadow px-4 py-2 w-3/4 mt-2 mb-2 dark:bg-slate-800 dark:border-slate-600 dark:text-gray-300">Vérifier les voies d'élimination principales du médicament. Lorsque plus de 20 % du produit passe par le foie, la présence d'hépatopathie peut avoir un impact important.</div>
                @include('svg.arrow', ['class' => 'w-16 h-16 fill-current text-red-400'])
                <div class="bg-gray-100 rounded border border-gray-400 text-gray-800 font-thin shadow px-4 py-2 w-3/4 mt-2 mb-2 dark:bg-slate-800 dark:border-slate-600 dark:text-gray-300">Calculer le score CTP du patient.</div>
                @include('svg.arrow', ['class' => 'w-16 h-16 fill-current text-red-400'])
                <div class="bg-gray-100 rounded border border-gray-400 text-gray-800 font-thin shadow px-4 py-2 w-3/4 mt-2 mb-2 dark:bg-slate-800 dark:border-slate-600 dark:text-gray-300">Vérifier si la monographie du médicament propose un ajustement posologique particulier pour le degré d'atteinte hépatique estimé du patient.</div>
                @include('svg.arrow', ['class' => 'w-16 h-16 fill-current text-red-400'])
                <div class="bg-gray-100 rounded border border-gray-400 text-gray-800 font-thin shadow px-4 py-2 w-3/4 mt-2 mb-2 dark:bg-slate-800 dark:border-slate-600 dark:text-gray-300">Vérifier si des études de pharmacocinétique ont évalué le médicament prescrit chez des patients souffrant de cirrhose (vérifier si l'état de votre patient est comparable à celui de la population à l'étude).</div>
                @include('svg.arrow', ['class' => 'w-16 h-16 fill-current text-red-400'])
                <div class="bg-gray-100 rounded border border-gray-400 text-gray-800 font-thin shadow px-4 py-2 w-3/4 mt-2 mb-2 dark:bg-slate-800 dark:border-slate-600 dark:text-gray-300">Si aucune donnée n'est disponible, vérifier s'il existe un médicament de la même classe pharmacothérapeutique pouvant être utilisé et pour lequel des données d'innocuité sont disponibles?</div>
                @include('svg.arrow', ['class' => 'w-16 h-16 fill-current text-red-400'])
                <div class="bg-gray-100 rounded border border-gray-400 text-gray-800 font-thin shadow px-4 py-2 w-3/4 mt-2 mb-2 dark:bg-slate-800 dark:border-slate-600 dark:text-gray-300">Si aucune alternative n'est possible, vérifier les paramètres pharmacocinétiques du médicament et vérifier si un ajustement de la dose est possible selon l'intervalle posologique recommandé et l'indication.</div>
                @include('svg.arrow', ['class' => 'w-16 h-16 fill-current text-red-400'])
                <div class="bg-gray-100 rounded border border-gray-400 text-gray-800 font-thin shadow px-4 py-2 w-3/4 mt-2 mb-2 dark:bg-slate-800 dark:border-slate-600 dark:text-gray-300">Dosage les concentrations sériques de la molécule lorsque possible et envisageable.</div>
            </div>
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Références suggérées</h3>
            <ul>
