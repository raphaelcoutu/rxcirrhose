...
@section('content')
    ...
    <div class="mx-auto container flex flex-grow justify-between items-start pt-4 leading-loose tracking-normal">
        <div class="mx-auto w-full sm:w-3/4 bg-white border-t-8 border-red px-6 py-3 shadow dark:bg-slate-800 dark:border-red-500">
            <div class="flex border-b border-gray-400 items-center dark:border-slate-700">
                <h1 class="text-3xl leading-none text-red-500 dark:text-red-400">About Us</h1>
            </div>
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-700">Webmasters</h3>
            ...
            <div class="pl-2">
                <div class="border-b-2 border-gray-200 dark:border-slate-700">
                    ...
                    <div class="pl-2 text-gray-800 text-sm leading-none dark:text-gray-300">Pharmacist at CIUSSSE-CHUS, CHUS site</div>
                    <div class="pl-2 text-sm dark:text-gray-400">Review of drug datasheets</div>
                </div>
                <div class="border-b-2 border-gray-200 dark:border-slate-700">
                    <div class="text-red-800 dark:text-red-400">Victor Ferreira, Pharm.D, M.Sc.</div>
                    <div class="pl-2 text-gray-800 text-sm leading-none dark:text-gray-300">Pharmacist at CHUM</div>
                    <div class="pl-2 text-sm dark:text-gray-400">Writing and review of drug datasheets</div>
                </div>
                <div class="border-b-2 border-gray-200 dark:border-slate-700">
                    <div class="text-red-800 dark:text-red-400">Alexandre Mathieu, Pharm.D, M.Sc.</div>
                    <div class="pl-2 text-gray-800 text-sm leading-none dark:text-gray-300">Pharmacist at CISSS de Lanaudière</div>
                    <div class="pl-2 text-sm dark:text-gray-400">Writing and review of drug datasheets</div>
                </div>
                <div>
                    <div class="text-red-800 dark:text-red-400">D<sup>r</sup> Julien Bissonnette, MD</div>
                    <div class="pl-2 text-gray-800 text-sm leading-none dark:text-gray-300">Hepatologist at CHUM</div>
                    <div class="pl-2 text-sm dark:text-gray-400">Review of drug datasheets</div>
                </div>
                </div>

            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-700">Collaborators</h3>
            <ul>
                ...
                <li>Lauriane Chagnon, candidate for Pharm.D (2025): Writing of drug datasheets</li>
            </ul>
        </div>
    </div>
