...
@section('content')
    ...
    <div class="mx-auto container flex flex-grow justify-between items-start pt-4 leading-loose tracking-normal">
        <div class="mx-auto w-full sm:w-3/4 bg-white border-t-8 border-red px-6 py-3 shadow">
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-light">Webmaîtres</h3>

            <div class="pl-2">
                <div class="border-b-2 border-gray-200">
                    <div class="text-red-800">Raphaël Coutu, Pharm.D, M.Sc.</div>
                    <div class="pl-2 text-gray-darker text-sm leading-none">Pharmacien au CIUSSSE-CHUS, site CHUS</div>
                    <div class="pl-2 text-sm">Révision des fiches</div>
                </div>
                <div class="border-b-2 border-gray-200">
                    <div class="text-red-800">Victor Ferreira, Pharm.D, M.Sc.</div>
                    <div class="pl-2 text-gray-darker text-sm leading-none">Pharmacien au CHUM</div>
                    <div class="pl-2 text-sm">Rédaction et révision de fiches</div>
                </div>
                <div class="border-b-2 border-gray-200">
                    <div class="text-red-800">Alexandre Mathieu, Pharm.D, M.Sc.</div>
                    <div class="pl-2 text-gray-darker text-sm leading-none">Pharmacien au CISSS de Lanaudière</div>
                    <div class="pl-2 text-sm">Rédaction et révision de fiches</div>
                </div>
                <div>
                    <div class="text-red-800">D<sup>r</sup> Julien Bissonnette, MD</div>
                    <div class="pl-2 text-gray-darker text-sm leading-none">Hépatologue au CHUM</div>
                    <div class="pl-2 text-sm">Révision des fiches</div>
                </div>
                </div>

            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-light">Collaborateurs</h3>
            <ul>
