...
@section('content')
    ...
    <div class="mx-auto container flex flex-grow justify-between items-start pt-4 leading-loose tracking-normal">
        <div class="mx-auto w-full bg-white border-t-8 border-red-500 px-6 py-3 shadow dark:bg-slate-800">
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Comment les fiches ont-elles été réalisées?</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">À quoi correspond la légende du tableau résumé se retrouvant au début de chaque fiche?</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Chez quel type de patient peut-on utiliser l’information du site?</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Est-ce normal que le site s'affiche mal sur mon navigateur?</h3>
