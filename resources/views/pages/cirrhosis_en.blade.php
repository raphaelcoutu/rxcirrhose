...
@section('content')
    ...
    <div class="mx-auto container flex flex-grow justify-between items-start pt-4 leading-loose tracking-normal">
        <div class="mx-auto w-full bg-white border-t-8 border-red-500 px-6 py-3 shadow">
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400">Etiologies</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400">Epidemiology</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400">Clinical presentation</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400">Pathophysiology and complications</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400">Cirrhosis severity</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400">Pharmacokinetic alterations</h3>
