...
@section('content')
    ...
    <div class="mx-auto container flex flex-grow justify-between items-start pt-4 leading-loose tracking-normal">
        <div class="mx-auto w-full bg-white border-t-8 border-red-500 px-6 py-3 shadow dark:bg-slate-800">
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Etiologies</h3>
            <p class="mt-2">There are many causes of chronic hepatic injury :</p>
            <table class="w-full">
                <tbody>
                <tr>
                    <td class="bg-gray-200 font-sans text-sm text-gray-800 border-b border-gray-400 dark:bg-slate-700 dark:text-slate-300">Hepatotropic virus</td>
                    <td class="border-b-2 border-gray-100 dark:border-slate-600 dark:text-gray-300">hepatitis B, hepatitis C, hepatitis delta</td>
                </tr>
                <tr>
                    <td class="bg-gray-200 font-sans text-sm text-gray-800 border-b border-gray-400 dark:bg-slate-700 dark:text-slate-300">Metabolic</td>
                    <td class="border-b-2 border-gray-100 dark:border-slate-600 dark:text-gray-300">hemochromatosis, Wilson's disease, alpha1-antitrypsin deficit</td>
                </tr>
                <tr>
                    <td class="bg-gray-200 font-sans text-sm text-gray-800 border-b border-gray-400 dark:bg-slate-700 dark:text-slate-300">Autoimmune</td>
                    <td class="border-b-2 border-gray-100 dark:border-slate-600 dark:text-gray-300">autoimmune diseases, primary biliary cholangitis</td>
                </tr>
                <tr>
                    <td class="bg-gray-200 font-sans text-sm text-gray-800 border-b border-gray-400 dark:bg-slate-700 dark:text-slate-300">Vascular</td>
                    <td class="border-b-2 border-gray-100 dark:border-slate-600 dark:text-gray-300">Budd-Chiari, right-sided heart failure</td>
                </tr>
                <tr>
                    <td class="bg-gray-200 font-sans text-sm text-gray-800 border-b border-gray-400 dark:bg-slate-700 dark:text-slate-300">Others</td>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Epidemiology</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Clinical presentation</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Pathophysiology and complications</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Cirrhosis severity</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Pharmacokinetic alterations</h3>
            ...
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Reflective approach</h3>
            ...
            <div class="flex flex-col justify-center items-center">
                <div class="bg-gray-100 rounded border border-gray-400 text-gray-800 font-thin shadow px-4 py-2 w-3/4 mt-2 mb-2 dark:bg-slate-800 dark:border-slate-600 dark:text-gray-300">Identify the drugs' primary elimination routes (hepatic, renal, etc.) When over 20% of the product is hepatically removed, presence of cirrhosis can have a significant impact.</div>
                @include('svg.arrow', ['class' => 'w-16 h-16 fill-current text-red-400'])
                <div class="bg-gray-100 rounded border border-gray-400 text-gray-800 font-thin shadow px-4 py-2 w-3/4 mt-2 mb-2 dark:bg-slate-800 dark:border-slate-600 dark:text-gray-300">Calculate the patient's CTP score</div>
                @include('svg.arrow', ['class' => 'w-16 h-16 fill-current text-red-400'])
                <div class="bg-gray-100 rounded border border-gray-400 text-gray-800 font-thin shadow px-4 py-2 w-3/4 mt-2 mb-2 dark:bg-slate-800 dark:border-slate-600 dark:text-gray-300">Consult the product monograph to see if the manufacturer listed recommendations on drug dosing in hepatic impairment.</div>
                @include('svg.arrow', ['class' => 'w-16 h-16 fill-current text-red-400'])
                <div class="bg-gray-100 rounded border border-gray-400 text-gray-800 font-thin shadow px-4 py-2 w-3/4 mt-2 mb-2 dark:bg-slate-800 dark:border-slate-600 dark:text-gray-300">Search for pharmacokinetic studies of the drug in hepatic impairment (and verify if the included population corresponds to the patient being evaluated).</div>
                @include('svg.arrow', ['class' => 'w-16 h-16 fill-current text-red-400'])
                <div class="bg-gray-100 rounded border border-gray-400 text-gray-800 font-thin shadow px-4 py-2 w-3/4 mt-2 mb-2 dark:bg-slate-800 dark:border-slate-600 dark:text-gray-300">If no data is available, look for alternative drugs in the same therapeutic class for which data in hepatic impairment is available.</div>
                @include('svg.arrow', ['class' => 'w-16 h-16 fill-current text-red-400'])
                <div class="bg-gray-100 rounded border border-gray-400 text-gray-800 font-thin shadow px-4 py-2 w-3/4 mt-2 mb-2 dark:bg-slate-800 dark:border-slate-600 dark:text-gray-300">If no alternative is available, analyze the pharmacokinetic properties of the drug and determine if the dosage can and should be adjusted, in regards to the usual dosage range and the indication.</div>
                @include('svg.arrow', ['class' => 'w-16 h-16 fill-current text-red-400'])
                <div class="bg-gray-100 rounded border border-gray-400 text-gray-800 font-thin shadow px-4 py-2 w-3/4 mt-2 mb-2 dark:bg-slate-800 dark:border-slate-600 dark:text-gray-300">Carry out therapeutic drug monitoring, if possible and relevant.</div>
            </div>
            <h3 class="mt-4 px-2 bg-gray-100 border-t border-b border-gray-400 dark:bg-slate-800 dark:border-slate-600">Suggested references</h3>
            <ul>
